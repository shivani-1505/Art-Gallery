...
const ArtGalleryPage = () => {
  ...
  <p className="text-gray-500 max-w-md">
    Explore our diverse exhibitions, from stunning paintings to captivating illustrations,
    thought-provoking installations to beautiful sculptures.
  </p>
</div>
        ...
        <div className="w-1/2 flex justify-center items-center mt-20">
          <Swiper
            ...
            autoplay={{ delay: 3000 }}
            className="w-3/4 h-[65vh] items-center" // Reduce height
          >
